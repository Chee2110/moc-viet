...
const NEXT_STATUS = { pending:['approved','rejected'], approved:['shipping'], shipping:['completed'] };
const NEXT_LABEL  = { approved:'Duyệt', rejected:'Từ chối', shipping:'Giao hàng', completed:'Hoàn thành' };
